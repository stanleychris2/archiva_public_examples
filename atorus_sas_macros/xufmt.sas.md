...
5. Sort formats and remove non-unique combinations
```sas
...
Code available at [xufmt.sas](https://github.com/atorus-research/atorus-sas-macros/blob/dev/sas/global/xufmt.sas)