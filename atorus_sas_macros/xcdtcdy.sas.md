...
2. Check for required parameters and their values
3. Check for invalid characters in dates
4. Calculate --DY variable based on input dates
...
[Link to the code file](https://github.com/atorus-research/atorus-sas-macros/blob/dev/sas/global/xcdtcdy.sas)